...
public class MyString {
    ...
    public static String randomStringOfLetters(int n) {
        String newString = "";
        for(int i = 0; i < n; i++) {
            newString = newString + (char)((int) (Math.random() * (122 - 97 + 1)) + 97);
        }
        return newString;
    }
    ...
    public static String remove(String str1, String str2) {
       ...
       for(int i = 0; i < str2.length(); i++) {
            if(str1.indexOf(str2.charAt(i)) != -1) {
                if(str1.indexOf(str2.charAt(i)) == str1.length() - 1) {
                    str1 = str1.substring(0, str1.length() - 1);
                }
                else {
                    str1 = str1.substring(0, str1.indexOf(str2.charAt(i))) + str1.substring(str1.indexOf(str2.charAt(i)) + 1, str1.length());
                }
            }
       }
        return str1;
